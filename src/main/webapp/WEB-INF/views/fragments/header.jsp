...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
      <header class="navbar navbar-inverse navbar-static-top red">
          <div class="container">
              <div><a href="<c:url value="/main" />" class="navbar-brand"><img src="<c:url value='/static/img/logo.png' />" width="70" height="30" alt="Logo"></a></div>
                          ...
                          <li class="dropdown">
                             <a class="dropdown-toggle" data-toggle="dropdown" href="#" > ${loggedinuser} <b class="caret"></b></a>
                              <ul class="dropdown-menu">
                                  ...
                                  <li><a href="<c:url value="/activecourse.jsp" />Active course</a></li>
                                  <li><a href="<c:url value="/allcourses.jsp" />All courses</a></li>
                              </ul>
                          </li>
